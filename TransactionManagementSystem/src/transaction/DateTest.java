...
class DateTest {
	...
	void setUp() throws Exception {
		/*
		 * The test case input should is not accepted as a string It must be added as
		 * the constructor states (month,day,year) We implemented the string to int
		 * conversion in the Transaction class instead of Date class
		 */
