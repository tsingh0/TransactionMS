package transaction;
/**
 * Checking is an Account subclass that waives monthly fees if the account has direct deposit
 * Checking Accounts have an annual interest rate of 0.05% and
 * a monthly fee of $25 but is waived if the balance is $1,500. Checking class 
...
public class Checking extends Account {
	 ...
	 * @param directDeposit boolean that determines whether the Checking Account has direct deposit
	 */
	...
	/**
	 * Checks if the objects are both Checking Accounts and returns if they are equal
