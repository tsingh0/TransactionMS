...
public class Checking extends Account{
	...
	//IDk if were supposed to compare the get date strings or compare if the date is less than or shit
	...
	public String toString() {
		...
		return this.getHolder() + " " + this.getBalance() +" " + this.getDateOpen() + " " + this.directDeposit;
