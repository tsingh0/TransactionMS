...
/**
 * Savings Account is an Account subclass that gives loyal customers a
 * promotional interest rate of 0.35% Savings Accounts have a monthly fee of $5
 * and are waived if the account balance is greater than or equal to $300.00.
