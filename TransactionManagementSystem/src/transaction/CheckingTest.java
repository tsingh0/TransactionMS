...
class CheckingTest {
	...
	void testMonthlyInterest() {
		...
		/*
		 * assertEquals has to be used to check if predicted output is same as the one returned
		 * Because we formatted the output only when printing, the non-rounded interests have to be used for testing
		 */
		assertEquals(0.020833333333333332, test1.monthlyInterest()); //test case 1, testing the monthly interest for $500
		...
		assertEquals(0.019792499999999998, test5.monthlyInterest()); //test case 5, testing the monthly interest for $475.02
		assertEquals(0.0625025, test6.monthlyInterest());			 //test case 6, testing the monthly interest for $1500.06
		assertEquals(0.011464166666666666, test7.monthlyInterest()); //test case 7, testing the monthly interest for $275.14
