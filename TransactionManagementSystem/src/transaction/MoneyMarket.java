package transaction;
/**
 * Money Market is an Account subclass that Cannot waive fees if the number of withdrawals exceed 6.
 * Money Markets monthly fees are $12 and are waived if the account balance is greater than $2,500
 * Money Market Class extends the Account Class
...
public class MoneyMarket extends Account {
	 ...
	 * @param withdrawals int for the current number of withdrawals that the account has
	 */
	...
	/**
	 * Checks if the objects are both Money Market Accounts and returns if they are equal
